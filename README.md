...
### Автоматизируемые сценарии
   ...
   **2. Проверка заполнения формы данными позитивными сценариями и негативными**  
    **Позитивные сценарии** - заполнение формы корректными данными (имя русскими буквами, коректный номер телефона, корректный e-mail).  
    ...
    1. Ввести в поле "Телефон" строку, представляющую корректный стационарный номер (например, 8 495 787 4567);  
    ОР: во всех перечисленных случаях введенные данные считаются корректными, сообщение об ошибке не выводится.  
    ...
    1. Ввести в поле "Электронная почта" строку, представляющую корректный e-mail и не оканчивающуюся на ".ru"(например, iivanov@securities.com);  
    ОР: во всех перечисленных случаях введенные данные считаются корректными, сообщение об ошибке не выводится.  
